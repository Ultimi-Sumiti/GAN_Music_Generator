...
INPUT_DIR_PATH = "./raw/maestro-v3.0.0/2009"
# Define the output directory path.
OUT_DIR_PATH = "./preprocessed/maestro-v3.0.0/dataset1/"
# Define output file name.
OUT_FILE_NAME = "2009_50k_augmented.h5"


def extract_samples(dir_path, samples):
    """This function is used to extract samples from all the midi files found at
    the given dir_path.

    Arguments:
        dir_path   The path of the directory with midi files.
        samples    List where we place all the sample that we extract.
    """
    # Iterate through.
